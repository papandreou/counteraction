...
module.exports = class LowerGreek {
  ...
  renderGreekNumeralMinuscules(counterValue) {
    ...
    if (counterValue >= 1e16) {
      return (
        this.renderGreekNumeralMinuscules(Math.floor(counterValue / 1e16)) +
        'μμμμ' +
        (counterValue === 1e16
          ? ''
    ...
    if (counterValue >= 1e12) {
      return (
        this.renderGreekNumeralMinuscules(Math.floor(counterValue / 1e12)) +
        'μμμ' +
        (counterValue === 1e12
          ? ''
    ...
    if (counterValue >= 1e8) {
      return (
        this.renderGreekNumeralMinuscules(Math.floor(counterValue / 1e8)) +
        'μμ' +
        (counterValue === 1e8
          ? ''
    ...
    if (counterValue >= 1e4) {
      return (
        this.renderGreekNumeralMinuscules(Math.floor(counterValue / 1e4)) +
        'μ' +
        (counterValue === 1e4
          ? ''
    ...
    if (counterValue >= 1e3) {
      return (
        '͵' +
        this.renderGreekNumeralMinuscules(Math.floor(counterValue / 1e3)) +
        (counterValue === 1e3
          ? ''

...
module.exports = class Hebrew {
  ...
  renderItem(counterValue) {
    ...
    if (counterValue >= 800) {
      return (
        'תת' + (counterValue === 800 ? '' : this.renderItem(counterValue % 100))
      );
    }
    if (counterValue >= 745) {
    ...
    if (counterValue >= 700) {
      return (
        'תש' + (counterValue === 700 ? '' : this.renderItem(counterValue % 100))
      );
    }
    if (counterValue >= 699) {
    ...
    if (counterValue >= 600) {
      return (
        'תר' + (counterValue === 600 ? '' : this.renderItem(counterValue % 100))
      );
    }
    if (counterValue >= 500) {
      return (
        'תק' + (counterValue === 500 ? '' : this.renderItem(counterValue % 100))
      );
    }
    if (counterValue >= 400) {
      return (
        'ת' + (counterValue === 400 ? '' : this.renderItem(counterValue % 100))
      );
    }
    if (counterValue >= 345) {
    ...
    if (counterValue >= 300) {
      return (
        'ש' + (counterValue === 300 ? '' : this.renderItem(counterValue % 100))
      );
    }
    if (counterValue >= 299) {
    ...
    if (counterValue >= 200) {
      return (
        'ר' + (counterValue === 200 ? '' : this.renderItem(counterValue % 100))
      );
    }
    if (counterValue >= 100) {
      return (
        'ק' + (counterValue === 100 ? '' : this.renderItem(counterValue % 100))
      );
    }
    if (counterValue >= 90) {
      return (
        'צ' + (counterValue === 90 ? '' : this.renderItem(counterValue % 10))
      );
    }
    if (counterValue >= 80) {
      return (
        'פ' + (counterValue === 80 ? '' : this.renderItem(counterValue % 10))
      );
    }
    if (counterValue >= 70) {
      return (
        'ע' + (counterValue === 70 ? '' : this.renderItem(counterValue % 10))
      );
    }
    if (counterValue >= 60) {
      return (
        'ס' + (counterValue === 60 ? '' : this.renderItem(counterValue % 10))
      );
    }
    if (counterValue >= 50) {
      return (
        'נ' + (counterValue === 50 ? '' : this.renderItem(counterValue % 10))
      );
    }
    if (counterValue >= 40) {
      return (
        'מ' + (counterValue === 40 ? '' : this.renderItem(counterValue % 10))
      );
    }
    if (counterValue >= 30) {
      return (
        'ל' + (counterValue === 30 ? '' : this.renderItem(counterValue % 10))
      );
    }
    if (counterValue >= 20) {
      return (
        'כ' + (counterValue === 20 ? '' : this.renderItem(counterValue % 10))
      );
    }
    if (counterValue >= 17) {
    ...
    if (counterValue >= 10) {
      return (
        'י' + (counterValue === 10 ? '' : this.renderItem(counterValue % 10))
      );
    }
    if (counterValue >= 9) {
      return 'ט';
